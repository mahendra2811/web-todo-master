...
const faqs = [
  {
    q: 'Is SupaTodo really free?',
    a: 'Yes, 100% free. No premium tier, no ads, no credit card required. Every feature is available to every user.',
  },
  {
    q: 'How do you make money?',
    a: "We don't. SupaTodo is a passion project built by developers who believe productivity tools should be free and accessible to everyone.",
  },
  {
    q: 'Is my data safe?',
  ...
  },
  {
    ...
    a: "Yes. SupaTodo works offline and automatically syncs your changes when you're back online.",
  },
  {
  ...
  },
  {
    ...
    a: 'Yes. SupaTodo is fully responsive and designed mobile-first. It works great on phones, tablets, and desktops.',
  },
  {
  ...
  },
  {
    ...
    a: "Contact us at support@supatodo.app and we'll delete all your data within 24 hours. No questions asked.",
  },
];
          ...
          return (
            <div key={i} className="rounded-xl border border-gray-200 bg-white overflow-hidden">
              <button onClick={() => setOpenIdx(isOpen ? null : i)}
                ...
                <svg className={`h-5 w-5 flex-shrink-0 text-gray-400 transition-transform duration-200 ${isOpen ? 'rotate-180' : ''}`}
