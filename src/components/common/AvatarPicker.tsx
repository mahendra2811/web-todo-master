...
const AVATARS: { id: string; label: string; svg: string; bg: string }[] = [
  { id: 'man-1', label: 'Man with glasses', bg: '#dbeafe',
  ...
  { id: 'woman-1', label: 'Woman with long hair', bg: '#fce7f3',
  ...
  { id: 'man-2', label: 'Man with beard', bg: '#dcfce7',
  ...
  { id: 'woman-2', label: 'Woman with bun', bg: '#f3e8ff',
  ...
  { id: 'man-3', label: 'Man with cap', bg: '#fee2e2',
  ...
  { id: 'woman-3', label: 'Woman with short hair', bg: '#fef9c3',
  ...
  { id: 'man-4', label: 'Man curly hair', bg: '#e0f2fe',
  ...
  { id: 'woman-4', label: 'Woman with headband', bg: '#ccfbf1',
  ...
  { id: 'man-5', label: 'Man formal', bg: '#e2e8f0',
  ...
  { id: 'woman-5', label: 'Woman professional', bg: '#fae8ff',
  ...
  { id: 'man-6', label: 'Man sporty', bg: '#fff7ed',
  ...
  { id: 'woman-6', label: 'Woman casual', bg: '#ffe4e6',
  ...
  { id: 'neutral-1', label: 'Robot', bg: '#f1f5f9',
  ...
  { id: 'neutral-2', label: 'Cat', bg: '#fef3c7',
  ...
  { id: 'neutral-3', label: 'Astronaut', bg: '#e0e7ff',
  ...
  { id: 'neutral-4', label: 'Ninja', bg: '#1e293b',
