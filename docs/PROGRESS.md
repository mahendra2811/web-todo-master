...
- [x] Learning docs: DATABASE_FUNCTIONS.md written
- [x] Learning docs: PERFORMANCE.md written
...
- [x] List detail page with todo CRUD
- [x] Todo form (create/edit)
- [x] Subtask support
- [x] Tag management
- [x] Sorting & filtering
...
- [x] All learning docs completed
- [x] Security checklist verified
- [x] Learning docs: EDGE_FUNCTIONS.md written
- [x] Learning docs: STORAGE.md written
- [x] Learning docs: SECURITY_CHECKLIST.md written
